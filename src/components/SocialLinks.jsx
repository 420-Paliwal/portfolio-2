...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/harsh-paliwal-",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "Harsh Paliwal",
    icon: Instagram,
    url: "https://www.instagram.com/harsh.9_4/",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@Harsh Vlogs",
    icon: Youtube,
    url: "https://www.youtube.com/@Harsh-Paliwal-HP4",
    color: "#FF0000",
  ...
  },
  {
    ...
    subText: "@420-Paliwal",
    icon: Github,
    url: "https://github.com/420-Paliwal/",
    color: "#ffffff",
          ...
          {[instagram, youtube].map((link) => (
            <a
              ...
              className="group relative flex items-center gap-3 p-4 rounded-xl 
                       bg-white/5 border border-white/10 overflow-hidden
                       hover:border-white/20 transition-all duration-500 mt-6"
            >
